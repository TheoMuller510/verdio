...
export const FeedCard = ({ userId, pseudo, challengeIcon, challengeTitle, likes: initialLikes }) => {
        ...
        <div className="card bg-base-100 shadow-md">
            <div className="card-body flex-row items-center gap-4 p-4">
                ...
                <p className="flex-1 text-sm">
                    <Link to={`/profil/${userId}`} className="font-semibold hover:text-primary transition-colors">{pseudo}</Link>
                    {' '}a validé{' '}
                    <span role="img" aria-hidden="true">{challengeIcon}</span>
                    {' '}
